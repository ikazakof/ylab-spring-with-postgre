...
public class UserController {
    ...
    @Operation(summary = "Update user with his books by user id.",
            responses = {@ApiResponse(description = "User book",
                    content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                            schema = @Schema(implementation = UserBookResponse.class)))})
    public UserBookResponse updateUserWithBooks(@PathVariable Long userId, @RequestBody UserBooksWithIdRequest request) {
    ...
    @Operation(summary = "Get user with his books by user id.",
            responses = {@ApiResponse(description = "User book",
                    content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                            schema = @Schema(implementation = UserBookResponse.class)))})
    ...
    @Operation(summary = "Delete user with his books by user id.")
